...
@implementation UIKit_UINavigationBar_UINavigationBarAppearance { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, "UIKit.UIColor, Xamarin.iOS", "UIKit.UINavigationBar+UINavigationBarAppearance, Xamarin.iOS", "set_BarTintColor");
	}
@end
...
@implementation UIKit_UITabBar_UITabBarAppearance { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, "UIKit.UIColor, Xamarin.iOS", "UIKit.UITabBar+UITabBarAppearance, Xamarin.iOS", "set_BarTintColor");
	}

	-(void) setSelectedImageTintColor:(UIColor *)p0
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_14 (self, _cmd, &managed_method, p0, "UIKit.UIColor, Xamarin.iOS", "UIKit.UITabBar+UITabBarAppearance, Xamarin.iOS", "set_SelectedImageTintColor");
	}
@end
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [45].handle = objc_getClass ("UINib");
	...
	__xamarin_class_map [53].handle = objc_getClass ("UITableViewController");
	...
	__xamarin_class_map [61].handle = objc_getClass ("UINavigationBar");
	__xamarin_class_map [62].handle = objc_getClass ("UITextView");
	...
	__xamarin_class_map [78].handle = objc_getClass ("UIKit_UIView_UIViewAppearance");
	__xamarin_class_map [79].handle = objc_getClass ("UIKit_UINavigationBar_UINavigationBarAppearance");
