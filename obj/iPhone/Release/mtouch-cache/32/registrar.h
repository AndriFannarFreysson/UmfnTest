...
@class AppDelegate;
@class MyCustomCell;
@class AndriFannarUmfn_MyTableViewSource;
@class AndriFannarUmfn_SoccerPlayersDetailView;
@class GamesViewController;
@class SoccerGamesTable;
@class TableStatusViewController;
@class AndriFannarUmfn_LeagueTableSource;
@class ViewController;
@class AndriFannarUmfn_SoccerGamesCell;
@class AndriFannarUmfn_LeagueTableCell;
